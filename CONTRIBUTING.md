...
* GitHub Issues: <https://github.com/ramsey/php-library-skelton/issues>
...
* ramsey/php-library-skelton follows a superset of **[PSR-12 coding standard][psr-12]**.
  Please ensure your code does, too. _Hint: run `composer dev:lint` to check._
* Please **write tests** for any new features you add.
* Please **ensure that tests pass** before submitting your pull request.
  ramsey/php-library-skelton automatically runs tests for pull requests. However,
...
[github]: https://github.com/ramsey/php-library-skelton
[issues]: https://github.com/ramsey/php-library-skelton/issues
[pull requests]: https://github.com/ramsey/php-library-skelton/pulls
