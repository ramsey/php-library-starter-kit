...
* GitHub Issues: <https://github.com/ramsey/php-library-skeleton/issues>
...
* Please **ensure that tests pass** before submitting your pull request.
  ramsey/php-library-skeleton has Travis CI automatically running tests for pull requests.
